...
**Note:** *This mod was created almost exclusivly with the help of ChatGPT and Claude Sonnet 4/4.5. I have negligable knowledge in coding and could not have made this mod without these LLMs.*
...
2. `[HH:mm]` references the time you want the message to trigger in a 24 hour format. So if you want your message to trigger at 3 in the afternoon (based on the host machine's timezone), then you would type [15:00] (excluding the brackets).
3. `[Type your message here with up to 27 words!]`. Pretty self explanatory (exclude the brackets).
